   ...
   if (fpIn)
   {
     ...
     printf("Connected to remote host, sending filename... \n");
      ...
      if (strcmp(acknowledgement, "Done") == 0)
      {
         ...
         printf("Filename succesfully received by remote host.\n");
         printf("Sending file...\n");
         ...
         while (1)
         {
          ...
          printf("Successfully sent file to remote host.\n");
      }
...
//  /media/sf_SharedFolderVM/gggg.mp4
//  /media/sf_SharedFolderVM/Krishna.jpg
//  /media/sf_SharedFolderVM/levi.jpeg
//  /media/sf_SharedFolderVM/linked_list.cpp